  ...
  return (
    <div className="form-control w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="form-control">
          <label className="label" htmlFor="fechaEntradaEstimada">
            <span className="label-text font-medium">Fecha Estimada de Entrada</span>
          </label>
          <input
            type="date"
            id="fechaEntradaEstimada"
            name="fechaEntradaEstimada"
            value={formData.fechaEntradaEstimada || ''}
            onChange={handleChange}
            className={`input input-bordered w-full ${errors.fechaEntradaEstimada ? 'input-error' : ''}`}
          />
          {errors.fechaEntradaEstimada && (
            <label className="label">
              <span className="label-text-alt text-error">{errors.fechaEntradaEstimada}</span>
            </label>
          )}
        </div>
