...
const Form = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.direccionEmpleador) newErrors.direccionEmpleador = 'La dirección del empleador es requerida';
    if (!formData.telefonoEmpleador) newErrors.telefonoEmpleador = 'El teléfono del empleador es requerido';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('/api/india', {
        method: 'POST',
        headers: {
