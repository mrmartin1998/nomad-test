        ...
        <div className="w-full aspect-[2/1] rounded-lg overflow-hidden bg-base-200 flex flex-col md:flex-row gap-0">
          ...
          <div className="w-full md:w-1/2 h-1/2 md:h-full aspect-[1/1] md:aspect-auto relative">
            <iframe
              ...
              src="https://www.youtube.com/embed/1bF3K1tGq8A" // Placeholder video, update if you have a UK-specific video
              title="UK Inspiration Video"
              frameBorder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowFullScreen
            ></iframe>
            <div className="absolute bottom-2 left-2 bg-black/60 text-white px-3 py-1 rounded text-sm font-semibold">ETA UK for Spanish Citizens</div>
          </div>
          {/* Four Images (right) */}
          <div className="w-full md:w-1/2 h-1/2 md:h-full grid grid-cols-2 grid-rows-2">
            <div className="overflow-hidden">
              <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80" alt="London Skyline" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden">
              <img src="https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80" alt="UK Beach" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden">
              <img src="https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?auto=format&fit=crop&w=400&q=80" alt="UK Monument" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden">
              <img src="https://images.unsplash.com/photo-1465447142348-e9952c393450?auto=format&fit=crop&w=400&q=80" alt="UK City" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto bg-base-100 rounded-xl shadow p-6 flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold mb-2">Get a Guaranteed ETA on</h2>
            ...
            <div className="flex-1 bg-base-50 rounded-lg p-4 border">
              ...
              <ul className="space-y-3 text-sm">
                <li><span className="font-bold">Nomad on your ETA!</span> Nomad works with the authorities to get your ETA on time!</li>
                <li><span className="font-bold">Public Holidays</span> We take into account public holidays observed in the UK.</li>
                <li><span className="font-bold">Weekends</span> UK authorities are shut on Saturday & Sunday. Your ETA cannot be processed then.</li>
              </ul>
            </div>
          </div>
        </div>
                      ...
                      <div className="card-body">
                        ...
                        <ul className="space-y-3">
                          ...
                          <li className="flex items-center gap-3 p-3 bg-base-200 rounded-lg">
                            <span className="text-primary text-xl">💳</span>
                            <div>
                              <h4 className="font-semibold">Tarjeta de Crédito o Débito</h4>
                      ...
                      <div className="card-body">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="p-4 bg-base-200 rounded-lg">
                            ...
                            <p className="text-base-content/70 mt-1">2 años o hasta la expiración del pasaporte</p>
                          </div>
                          <div className="p-4 bg-base-200 rounded-lg">
                            <h4 className="font-semibold flex items-center gap-2">
                              <span className="text-primary">💰</span>
                            ...
                            <p className="text-base-content/70 mt-1">Desde £10</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="relative max-w-3xl mx-auto w-full">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-4">
                          ...
                          <div className="card bg-base-100 shadow-xl flex-1">
                            <div className="card-body p-4">
                              <h3 className="card-title text-lg">Reciba su ETA</h3>
                              <p className="text-base-content/70 text-sm">Autorización enviada por email</p>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                {activeTab === 'Preguntas' && (
                  <div className="mt-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="card bg-base-100 shadow-xl">
                        <div className="card-body">
                          <h3 className="card-title">¿Cuánto tiempo es válida la ETA?</h3>
          ...
          <div className="card bg-primary text-primary-content shadow-xl">
            <div className="card-body">
              ...
              <Link href="/uk/apply" className="btn btn-secondary btn-lg">
                <span className="mr-2">✈️</span> Solicitar ETA
              </Link>
            </div>
          </div>
        </div>
            ...
            const faqs = [
              {
                ...
                answer: 'El procesamiento típicamente toma 24-48 horas.'
              },
              {
                question: '¿Qué documentos necesito?',
                answer: 'Necesitará un pasaporte válido y una foto reciente.'
              },
              {
                question: '¿Cuánto tiempo es válida la ETA?',
                answer: 'La ETA es válida por 2 años o hasta que expire su pasaporte.'
              }
            ];
            return (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="card bg-base-100 shadow-xl">
              ...
              <div className="card-body items-center text-center pt-2">
                ...
                <p className="text-base-content/70 italic">
                  "El proceso fue mucho más sencillo de lo que esperaba. En menos de una semana tenía mi ETA aprobada."
                </p>
                <div className="badge badge-primary">ETA UK</div>
              </div>
            </div>
