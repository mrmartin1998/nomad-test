        ...
        <div className="w-full aspect-[2/1] rounded-lg overflow-hidden bg-base-200 flex flex-col md:flex-row gap-0">
          ...
          <div className="w-full md:w-1/2 h-1/2 md:h-full aspect-[1/1] md:aspect-auto relative">
            <iframe
              ...
              src="https://www.youtube.com/embed/1bF3K1tGq8A" // Placeholder video, update if you have an Egypt-specific video
              title="Egypt Inspiration Video"
              frameBorder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowFullScreen
            ></iframe>
            <div className="absolute bottom-2 left-2 bg-black/60 text-white px-3 py-1 rounded text-sm font-semibold">Egypt Visa for Spanish Citizens</div>
          </div>
          {/* Four Images (right) */}
          <div className="w-full md:w-1/2 h-1/2 md:h-full grid grid-cols-2 grid-rows-2">
            <div className="overflow-hidden">
              <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80" alt="Cairo Skyline" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden">
              <img src="https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80" alt="Egyptian Beach" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden">
              <img src="https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?auto=format&fit=crop&w=400&q=80" alt="Pyramids" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden">
              <img src="https://images.unsplash.com/photo-1465447142348-e9952c393450?auto=format&fit=crop&w=400&q=80" alt="Egyptian Market" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              <div className="badge badge-primary mb-4">eVisa Egipto</div>
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Visa Electrónica para Egipto</h1>
              <p className="text-lg text-base-content/70 mb-8">Explore las maravillas del antiguo Egipto con una visa electrónica rápida y sencilla</p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/egypt/apply" className="btn btn-primary btn-lg w-full sm:w-auto">
                  Solicitar Ahora
                </Link>
